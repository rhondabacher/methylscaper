                 ...
                 tabPanel("Single-molecule",
                          navbarPage("",
                                     tabPanel("Preprocessing",
                                              fileInput("fasta.file", label = "Reads/Sequences File (.fa or .fasta)"),
                                              fileInput("ref.file", label = "Reference Sequene File (.fa or .fasta)"),
                                              textInput("gch.file.name", label = "GCH File Name", value="gch-matrix"),
                                              textInput("hcg.file.name", label = "HCG File Name", value="hcg-matrix"),
                                              textInput("processing.log.name", label = "Processing Log File Name", value="alignment-log"),
